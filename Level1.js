...
let mouseStartNode = 399, cheeseNode = 210;
...
let snapRangeX = 10, snapRangeY = 10;
...
const shape1 = {
    ...
    snap_Coordinates: [cheese_Location[0], cheese_Location[1] - (3 * cHeight) + 25],
    numOfVertices: 4,
    vertices: [[-95,  25],[-55, -25],[55, -25],[95, 25]],
    vertices_Coor: []
};
const shape2 = {
    snapped: false,
...
const shape3 ={
    snapped: false,
    shape_Coordinates: [0, 0],
    snap_Coordinates: [cheese_Location[0] + (3 * cWidth), cheese_Location[1]],
    numOfVertices: 6,
    vertices:[[5, -40],[ -45, -40],[ -25, 0],[ -45,  40],[5,  40],[25, 0]],
    vertices_Coor: []
};
const shape4 ={
    snapped: false,
